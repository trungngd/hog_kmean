	...
	try:	
		while True:
			...
			for kid in range(7):
				...
				if frame_idx in skeleton_all[kid]:
					...
					for skel in skels:
						...
						for k in range(3):					
							...
							cv2.line(img,(skel[k+4][0],skel[k+4][1]),(skel[k+4+1][0],skel[k+4+1][1]),(0,255,0),2)
							cv2.line(img,(skel[k+8][0],skel[k+8][1]),(skel[k+8+1][0],skel[k+8+1][1]),(0,255,0),2)
							cv2.line(img,(skel[k+12][0],skel[k+12][1]),(skel[k+12+1][0],skel[k+12+1][1]),(0,255,0),2)
							cv2.line(img,(skel[k+16][0],skel[k+16][1]),(skel[k+16+1][0],skel[k+16+1][1]),(0,255,0),2)
						k=0	
						...
						cv2.line(img,(skel[k+2][0],skel[k+2][1]),(skel[k+4][0],skel[k+4][1]),(0,255,0),2)
						cv2.line(img,(skel[k+2][0],skel[k+2][1]),(skel[k+8][0],skel[k+8][1]),(0,255,0),2)
						for i in range(20):
				...
				cv2.putText(img_total,str(kid+1),(location_x+10,location_y+60), cv2.FONT_HERSHEY_SIMPLEX, 2,(0,0,255),5,cv2.LINE_AA)
			# print depth.shape
			# break
			if img is None:
				break
